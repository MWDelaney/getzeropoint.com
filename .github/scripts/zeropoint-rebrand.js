/**
 * Get ZeroPoint Template Rebranding Script
...
const CONFIG = {
  ...
  replacements: [
    { search: 'Get ZeroPoint', replace: 'projectName' },
    { search: 'mwdelaney', replace: 'author' },
    { search: 'get-zeropoint', replace: 'projectName', transform: 'kebabCase' }
  ],
  ...
  fileOperations: [
    ...
    { type: 'copy', from: 'README.Get ZeroPoint.md', to: 'README.md' }
  ],
...
async function rebrand() {
  ...
  console.log('🪐 Welcome to Get ZeroPoint! Let\'s customize this for your project.\n');
